...
class FileCryptoService {
  ...
  static Future<void> encryptFileChunked(
    ...
    try {
      ...
      while (currentPos < fileLength) {
        ...
        final nonce = List<int>.generate(
            NONCE_LENGTH, (i) => Random.secure().nextInt(256));
  ...
  static Future<Uint8List> readAndDecryptRange(
      File encryptedFile, int offset, int length) async {
    await init();
